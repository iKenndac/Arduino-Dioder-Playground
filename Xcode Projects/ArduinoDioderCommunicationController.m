...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context {
    ...
    if ([keyPath isEqualToString:@"port"]) {
		...
		[self pushColorsToChannel1:self.currentChannel1Color
						  channel2:self.currentChannel2Color
						  channel3:self.currentChannel3Color
						  channel4:self.currentChannel4Color
					  withDuration:0.0];
